...
local function updateLibraryGrid(vehs)
	...
	for i = 1, #vehs do
		...
		if (vehs[i].enabled == 1)then
			guiGridListSetItemText(VehLibGrid, row, col.enabled,"Yes", false, true)
		else
			guiGridListSetItemText(VehLibGrid, row, col.enabled,"No", false, true)
		end
