	...
	if (exports.integration:isPlayerTrialAdmin(thePlayer)) then
		if commandName then
			if isTimer(respawnTimer) then
				outputChatBox("Momentálně respawn vozidel probíhá! Použij /respawnstop než zahájíš další respawn, nebo vyčkej, než se vozidla respawnou.", thePlayer, 255, 0, 0)
			else
				timeToRespawn = tonumber(timeToRespawn) or 30
				timeToRespawn = timeToRespawn < 5 and 5 or timeToRespawn
				...
				outputChatBox("*** Všechny auta budou respawnuty za "..timeToRespawn.." sekund! ***", getRootElement(), 255, 194, 14)
				outputChatBox("Respawn vozidel lze zastavit příkazem /respawnstop!", thePlayer)
		...
		outputChatBox(" =-=-=-=-=-=- Respawn vozidel úspěšný =-=-=-=-=-=-=", getRootElement(), 255, 194, 14)
		outputChatBox("Respawnuto " .. counter .. "/" .. counter + notmoved .. " vozidel. (" .. occupiedcounter .. " obsazeno) .", thePlayer)
		outputChatBox("Smazáno " .. tempcounter .. " temporary vozidel. (" .. tempoccupied .. " obsazeno).", thePlayer)
		outputChatBox(radioCounter .. "resetovaných rádií ve vozidlech.", thePlayer)
		outputChatBox("Odemčených a respawnutých " .. unlockedcivs .. " civilních vozidel.", thePlayer)
		outputChatBox("Smazáno " .. deleted .. " vozidel parkovaných v carshopu.", thePlayer)
		outputChatBox("Vše tohle trvalo " .. timeTaken .." sekund.", thePlayer)
	end
end
			...
			if targetPlayer then
				...
				if (logged==0) then
					...
					if (veh) then
						...
						jmeno1 = getPlayerName(thePlayer)
						exports['discord_webhook']:sendDiscordMessage("Člen týmu " .. username .. " opravil vozidlo hráči " .. targetPlayerName, "https://discord.com/api/webhooks/1068924838019858492/KPvBaHM84cMoFOEdrYwo1Cn-bYOV2JeYjsR1bV8PBnM9YiMhOKXddUyORZGQ3-YF_Cxr")
