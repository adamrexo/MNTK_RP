...
addEventHandler('crusher:show', root,
	function(price)
		...
		guiCreateLabel(20, 15, windowWidth - 40, 16, 'Právě vam bude zešrotované vozidlo, souhlasíte s tím?', false, window)
		...
		guiSetFont(guiCreateLabel(40, 90, windowWidth - 40, 16, 'Za $' .. exports.global:formatMoney(price), false, window), 'default-bold-small')

		local accept = guiCreateButton(10, 110, windowWidth / 2 - 15, 40, "Ano, zešrotuj to!", false, window)
		...
		local nope = guiCreateButton(windowWidth / 2 + 5, 110, windowWidth / 2 - 15, 40, "Chci si nechat vozidlo.", false, window)
