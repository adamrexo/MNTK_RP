...
function openVehicleDoorGUI( vehicleElement )
	...
	local options = 0
	local guiPos = 30
	vControlGUI["main"] = guiCreateWindow(700,236,272,288,"Ovládání vozidla",false)
	...
	vControlGUI["close"] = guiCreateButton(23,guiPos,230,14,"Zavřit",false, vControlGUI["main"])
