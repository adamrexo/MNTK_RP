...
local Johnson = createPed(211,  359.345703125, 173.6025390625, 1008.8891601562)
setPedRotation(Johnson, 260)
setElementDimension(Johnson, 201)
...
local dominick = createPed(187,  356.2568359375, 178.349609375, 1008.3763427734)
setPedRotation(dominick, 285)
setElementDimension(dominick, 201)
