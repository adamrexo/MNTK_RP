...
addCommandHandler({"togspeedcamera", "togglespeedcamera", "togspeedcam", "togglespeedcam", "togspeed", "togglespeed"},
	function(player, cmd, speed)
		...
		if vehicle then
			iprint("speedcam 1")
			if tonumber(getElementData(vehicle, "faction")) == 2 or tonumber(getElementData(vehicle, "faction")) == 50 or tonumber(getElementData(vehicle, "dbid") == 331) or tonumber(getElementData(vehicle, "faction")) == 45 or tonumber(getElementData(vehicle, "faction")) == 59 and (getVehicleController(vehicle) == player) then
