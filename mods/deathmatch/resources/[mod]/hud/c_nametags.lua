...
function getPlayerIcons(name, player, forTopHUD, distance)
	...
	local icons = {}
	if getElementData(player, "hiddenadmin") == 1 and getElementData(player, "duty_admin") == 1 or getElementData(player, "duty_admin") == 0 then
		name = name
	elseif getElementData(player, "duty_admin") == 1 then
		if getElementData(player, "admin_level") == 1 or getElementData(player, "admin_level") == 2 or getElementData(player, "admin_level") == 3 then
		name = "Administrátor | " .. getElementData(player, "account:username") .. ""

		elseif getElementData(player, "admin_level") == 4 then
			name = "Vedení projektu | " .. getElementData(player, "account:username") .. ""
		else 
			name = "Majitel projektu | " .. getElementData(player, "account:username") .. ""
		end
	end

	if getElementData(player, "duty_supporter") == 1 then
		name = "Support | " .. getElementData(player, "account:username") .. ""
	end
