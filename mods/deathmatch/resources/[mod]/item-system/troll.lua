	...
	if itemID then
		...
		elseif (itemID==3) then -- car key
			...
			if veh and getElementData(veh, "dbid") == itemValue then
				...
				if value then
					...
					outputChatBox("Nesprávne vozidlo.", source, 255, 194, 14)
				end
			end
		elseif (itemID==4) or (itemID==5) then -- house key or business key
			...
			if found then
				...
				if locked == 0 then
					exports.global:sendLocalMeAction(source, "vložil klíč do dveří aby jej odemknul.")
					if not (exports.global:hasItem(source, 4, found)) and not (exports.global:hasItem(source, 5, found)) then
						exports.logs:logMessage("[INTERIOR-UNLOCK] Interier #" .. found .. " byl odemčen hráčem " .. getPlayerName(source), 21)
					end
				else
					newRealLockedValue = true
					exports.global:sendLocalMeAction(source, "vložil klíč do dveří aby jej zamknul.")
					
					if not (exports.global:hasItem(source, 4, found)) and not (exports.global:hasItem(source, 5, found)) then
						exports.logs:logMessage("[INTERIOR-LOCK] Interier #" .. found .. " byl zamknut hráčem " .. getPlayerName(source), 21)
					end
				end
				...
				outputChatBox("Jsi moc daleko od dveří.", source, 255, 194, 14)
			end
		...
		elseif (itemID==8) then -- sandwich
			...
			exports.global:sendLocalMeAction(source, "snědl sendvič.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==9) then -- sprunk
			...
			toggleAllControls(source, true, true, true)
			triggerClientEvent(source, "onClientPlayerWeaponCheck", source)
			exports.global:sendLocalMeAction(source, "vypil sprite.")
			takeItemFromSlot(source, itemSlot)
		...
		elseif (itemID==11) then -- taco
			...
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "snědl taco.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==12) then -- cheeseburger
			giveHealth(source, 10)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			setTimer(removeAnimation, 4000, 1, source)
			exports.global:sendLocalMeAction(source, "snědl burger.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==13) then -- donut
			setElementHealth(source, 100)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "snědl donut.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==14) then -- cookie
			giveHealth(source, 80)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "snědl sušenku.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==15) then -- water
			giveHealth(source, 90)
			exports.global:applyAnimation(source, "VENDING", "VEND_Drink_P", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "vypil flašku perlivé vody.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==16) then -- clothes
			...
			--if fittingskins[gender] and fittingskins[gender][race] and fittingskins[gender][race][skin] then
				...
				exports.global:sendLocalMeAction(source, "převlékl se.")
				if vehicle then
		...
		elseif (itemID==17) then -- watch
			exports.global:sendLocalMeAction(source, "koukl se na hodinky.")
			outputChatBox("Aktualni čas je " .. string.format("%02d:%02d", getTime()) .. ".", source, 255, 194, 14)
