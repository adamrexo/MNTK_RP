function mixDrugs(drug1, drug2, drug1name, drug2name)
	...
	if (drugName == nil or drugID == nil) then
		outputChatBox("Error #1000 - Report to Thirew", source, 255, 0, 0)
		return
	end
	...
	if (given) then
		outputChatBox("Smíchal jsi '" .. drug1name .. "' a '" .. drug2name .. "' a vytvořil jsi '" .. drugName .. "'", source)
		exports.global:sendLocalMeAction(source, "vytvořil drogu.")
	else
		outputChatBox("Nemáš místo v inventáři.", source, 255, 0, 0)
