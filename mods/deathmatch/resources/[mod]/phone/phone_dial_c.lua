...
function drawPhoneDial()
	if isPhoneGUICreated() then
		...
		bCall = guiCreateButton(28,115,102,30,"Zavolat",false,wPhoneMenu)
		guiSetFont ( bCall, "default-bold-small" )
		bSMSDial = guiCreateButton(134,115,102,30,"SMS",false,wPhoneMenu)
		guiSetFont ( bSMSDial, "default-bold-small" )
