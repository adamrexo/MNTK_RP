...
function drawPhoneGUI()
	...
	wPhoneMenu = guiCreateStaticImage(posX, posY,w,h,"images/iphone.png",false)
	...
	bHome = guiCreateButton(btnM,btnPosY,btnW,btnH,"Domů",false,wPhoneMenu)
	guiSetFont ( bHome, "default-bold-small" )

	bPowerOn = guiCreateButton(btnM,btnPosY,btnW,btnH,"Zapnout",false,wPhoneMenu)
	guiSetFont ( bPowerOn, "default-bold-small" )
