...
drawScoreboard = function ()
	...
	local maxPlayers = getElementData ( root, "server:Slots" ) or 50
	...
	local strPlayerCount = "Hráčů: " .. tostring(#g_players) .. "/" .. tostring(maxPlayers) .. " (" .. math.floor(usagePercent + 0.5) .. "%)"
	...
	-- Draw the headers
	drawRowBounded ( "ID", "Jméno", "Hodiny", "Ping",
