...
-- connection settings
hostname = get("@mysql.core_hostname")
username = get("@mysql.core_username")
password = get("@mysql.core_password")
database = "mta_test"
port = 3306

core_hostname = get("@mysql.core_hostname")
core_username = get("@mysql.core_username")
core_password = get("@mysql.core_password")
core_database = "mta_test"
core_port = 3306
